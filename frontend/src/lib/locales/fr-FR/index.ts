export const frFR = {
  common: {
    ...
    context: {
      label: "Context:",
      empty: "No sources or notes included in context. Toggle icons on cards to include them.",
      insightsSources: "Insights for {count} source(s)",
      fullSources: "{count} full source(s)",
      fullNotes: "{count} full note(s)",
      tokens: "{count} tokens",
      chars: "{count} chars",
    },
