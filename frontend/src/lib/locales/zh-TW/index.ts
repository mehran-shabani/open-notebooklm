export const zhTW = {
  ...
  podcasts: {
    ...
    contextInsightsCount: "Insights for {count} source(s)",
    contextFullSourcesCount: "{count} full source(s)",
    contextFullNotesCount: "{count} full note(s)",
    contextTokens: "{count} tokens",
    contextChars: "{count} chars",
    toggleContextHint: "Toggle icons on cards to include them.",
  ...
  apiKeys: {
    ...
    credentialLinkedModels: "This credential has {count} linked model(s).",
